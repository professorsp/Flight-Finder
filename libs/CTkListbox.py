...
class CTkListbox(customtkinter.CTkScrollableFrame):
    def __init__(
        ...
        self.select_color = (
            customtkinter.ThemeManager.theme["CTkListbox"]["fg_color"]
            if highlight_color == "default"
            else highlight_color
        )
        self.text_color = (
            customtkinter.ThemeManager.theme["CTkListbox"]["text_color"]
            if text_color == "default"
            else text_color
        )
        self.hover_color = (
            customtkinter.ThemeManager.theme["CTkListbox"]["hover_color"]
